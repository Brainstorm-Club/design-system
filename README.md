...
| File | Cosa contiene |
|------|---------------|
| `tokens.css` | Fonte di verità: colori, tipografia, spazio, raggi, alias di tema. **Importa per primo.** |
| `components.css` | Componenti pronti con prefisso `.bsc-` (bottoni, badge, card, form, alert). |
